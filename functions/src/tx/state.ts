...
export const allowedTransitions: Record<TxStatus, TxStatus[]> = {
  AWAITING_DEPOSIT: ['DEPOSIT_SENT', 'CANCELLED', 'DISPUTED'],
  ...
  WITHDRAWAL_REQUESTED: ['WITHDRAWAL_CONFIRMED', 'DISPUTED', 'CANCELLED'],
  WITHDRAWAL_CONFIRMED: ['WITHDRAWAL_SENDING', 'WITHDRAWAL_SENT', 'DISPUTED', 'CANCELLED'], // Allow direct to SENT for simplicity
