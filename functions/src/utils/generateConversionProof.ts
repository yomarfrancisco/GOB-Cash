/**
 * FX Conversion Request for MozPay wholesale ZAR flow.
...
const DISCLAIMER =
  'This notification records an FX conversion request facilitated through MozPay. It is not a bank confirmation nor a proof of payment. Generated by MozPay.'
